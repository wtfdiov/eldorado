  ...
  constructor(props) {
    ...
    this.state = {
      transaction: props.transactions.find(
        item => item.id === props.transactionId
      )
    };
  }
      ...
      <Container>
        <Content>
          ...
          >
            <Pills
              icon={
                this.state.transaction.status === 2
          ...
          <Card>
            ...
            <CardItem bordered style={{ justifyContent: 'space-between' }}>
              ...
              <Text>
                {extra.paymentId ? stringFromHex(extra.paymentId) : 'N/A'}
              </Text>
            </CardItem>
            <CardItem
              bordered
              ...
              onPress={() =>
                Linking.openURL(
                  config.explorerHash.replace('@{hash}', transactionHash)
                )
              }
